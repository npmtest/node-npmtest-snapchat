...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-snapchat/node_modules/snapchat/lib/constants.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-snapchat/node_modules/snapchat/lib/constants.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-snapchat/node_modules/snapchat/lib/</a> &#187; constants.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">var Enum = require('enum')
&nbsp;
/**
 * @namespace
 */
...
&nbsp;
    ...
    digest: <span class="fstat-no" title="function not covered" >function () {</span>
      // var value = constants.attestation['digest9_14']
<span class="cstat-no" title="statement not covered" >      var value = constants.attestation['digest9_14_2']</span>
<span class="cstat-no" title="statement not covered" >      if (!value) <span class="cstat-no" title="statement not covered" >throw new Error('constants.attestation.digest invalid value')</span></span>
&nbsp;
...
&nbsp;
  ...
  // ---------------------------------------------------------------------------
&nbsp;
  addSourceFromString: <span class="fstat-no" title="function not covered" >function (addSource) {</span>
<span class="cstat-no" title="statement not covered" >    if (addSource === 'ADDED_BY_PHONE') {</span>
<span class="cstat-no" title="statement not covered" >      return constants.AddSource.Phonebook.value</span>
    } else <span class="cstat-no" title="statement not covered" >if (addSource === 'ADDED_BY_USERNAME') {</span>
<span class="cstat-no" title="statement not covered" >      return constants.AddSource.Username.value</span>
    } else <span class="cstat-no" title="statement not covered" >if (addSource === 'ADDED_BY_ADDED_ME_BACK') {</span>
<span class="cstat-no" title="statement not covered" >      return constants.AddSource.AddedBack.value</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    return 0</span>
  },
&nbsp;
  stringFromAddSource: <span class="fstat-no" title="function not covered" >function (addSource) {</span>
<span class="cstat-no" title="statement not covered" >    if (addSource === constants.AddSource.Phonebook.value) {</span>
<span class="cstat-no" title="statement not covered" >      return 'ADDED_BY_PHONE'</span>
    } else <span class="cstat-no" title="statement not covered" >if (addSource === constants.AddSource.Username.value) {</span>
<span class="cstat-no" title="statement not covered" >      return 'ADDED_BY_USERNAME'</span>
    } else <span class="cstat-no" title="statement not covered" >if (addSource === constants.AddSource.AddedBack.value) {</span>
<span class="cstat-no" title="statement not covered" >      return 'ADDED_BY_ADDED_ME_BACK'</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    return null</span>
  },
&nbsp;
  stringFromMediaKind: <span class="fstat-no" title="function not covered" >function (mediaKind) {</span>
<span class="cstat-no" title="statement not covered" >    return constants.MediaKind.get(mediaKind).key</span>
  },
&nbsp;
  stringFromStoryPrivacy: <span class="fstat-no" title="function not covered" >function (storyPrivacy) {</span>
<span class="cstat-no" title="statement not covered" >    if (storyPrivacy === constants.StoryPrivacy.Everyone.value) {</span>
<span class="cstat-no" title="statement not covered" >      return 'EVERYONE'</span>
    } else <span class="cstat-no" title="statement not covered" >if (storyPrivacy === constants.StoryPrivacy.Friends.value) {</span>
<span class="cstat-no" title="statement not covered" >      return 'FRIENDS'</span>
    } else <span class="cstat-no" title="statement not covered" >if (storyPrivacy === constants.StoryPrivacy.Custom.value) {</span>
...
&nbsp;
  messageKindFromString: <span class="fstat-no" title="function not covered" >function (messageKind) {</span>
<span class="cstat-no" title="statement not covered" >    messageKind = (messageKind || '').toLowerCase()</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (messageKind === constants.MessageKind.Text.key.toLowerCase()) {</span>
<span class="cstat-no" title="statement not covered" >      return constants.MessageKind.Text.value</span>
    } else <span class="cstat-no" title="statement not covered" >if (messageKind === constants.MessageKind.Media.key.toLowerCase()) {</span>
<span class="cstat-no" title="statement not covered" >      return constants.MessageKind.Media.value</span>
    } else <span class="cstat-no" title="statement not covered" >if (messageKind === constants.MessageKind.DiscoverShared.key.toLowerCase()) {</span>
<span class="cstat-no" title="statement not covered" >      return constants.MessageKind.DiscoverShared.value</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    return null</span>
  },
&nbsp;
  mediaKindIsImage: <span class="fstat-no" title="function not covered" >function (mediaKind) {</span>
<span class="cstat-no" title="statement not covered" >    return mediaKind === constants.MediaKind.Image.value ||</span>
           mediaKind === constants.MediaKind.StrangerImage.value
  },
&nbsp;
  mediaKindIsVideo: <span class="fstat-no" title="function not covered" >function (mediaKind) {</span>
<span class="cstat-no" title="statement not covered" >    return mediaKind === constants.MediaKind.Video.value ||</span>
